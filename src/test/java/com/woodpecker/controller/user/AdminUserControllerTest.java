...
import com.woodpecker.repository.UserRepository;
import com.woodpecker.controller.AbstractControllerTest;
...
import static com.woodpecker.controller.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
import static com.woodpecker.controller.user.UserTestData.*;
...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    void enable() throws Exception {
        ...
        Assertions.assertFalse(userRepository.getExisted(USER_ID).isEnabled());
    }
